...
2. Download a [versioned release](https://github.com/danusarf/glide/releases). Glide releases are semantically versioned.
...
4. The latest development snapshot can be installed with `go get`. For example, `go get -u github.com/danusarf/glide`. This is not a release version.
